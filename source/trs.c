...
static void
radixsort_x(unsigned *integers, unsigned *new_arr,
...
static void
radixsort_x(unsigned integers[], unsigned new_arr[], unsigned inds[],
...
radixsortupint()
{
  ...
  radixsort_x(zp, newzp, zp, t, 0, 0x7ff, false);
  radixsort_x(newzp, zp, zp, t, 11, 0x7ff, false);
  radixsort_x(zp, newzp, zp, t, 22, 0x3ff, false);
  i = 0;
...
radixgradeupint()
{
  ...
  radixsort_x(zp, newzp, indp, t, 0, 0x7ff, true);
  radixsort_x(zp, indp, newzp, t, 11, 0x7ff, true);
  radixsort_x(zp, newzp, indp, t, 22, 0x3ff, true);
  i = 0;
