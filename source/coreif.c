...
NC_UpdateWindowSettings(long WindowSettings)
{
  ...
  NC_SetWindowSettingP(WindowSettings, NC_LOG_NAME, logfnm);
  NC_SetWindowSettingP(WindowSettings, NC_FORMAT, getformat());
  NC_SetWindowSettingP(WindowSettings, NC_PROMPT, prompt);
...
int NC_SetWindowSettingP(long ioSettings, int inFeature, char *inValue) {
    ...
    DIAG_MSG3("SetWindowSetting", ioSettings, inFeature, inValue);
